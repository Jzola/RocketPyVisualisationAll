...
namespace BarGraph.VittorCloud
{
    ...
    public class BarGraphGenerator_Editor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Space();
            script.MaxHeight = (int)EditorGUILayout.IntField("Max Height (No. Y-Nodes)", script.MaxHeight);
            ...
            SerializedProperty xLength = serializedObject.FindProperty(GetMemberName(() => script.xLength));
            EditorGUILayout.PropertyField(xLength);
            SerializedProperty barWidth = serializedObject.FindProperty(GetMemberName(() => script.barWidth));
            EditorGUILayout.PropertyField(barWidth);
