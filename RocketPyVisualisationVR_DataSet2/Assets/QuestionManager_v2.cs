...
public class QuestionManager_v2 : MonoBehaviour
{
    ...
    private const string folder = "VR/DataSet2/scenario1";
    ...
    private void loadQuestions()
    {
        ...
        scenario1Questions.Add("As the grain number increases, what is the general trend of the graph along the Y-axis? ");
        scenario1Questions.Add("Considering the increase in grain density, what conclusions can be drawn about the landing locations of the first trajectory to the last?");
        ...
        scenario1Questions.Add("Identify the direction that the flight paths take along the X-axis when the fin distance to the centre of mass increases");
        scenario1Questions.Add("As the fin span increases, what is the general trend of the trajectories?");

        List<string> scenario2Questions = new List<string>();
        scenario2Questions.Add("At a windspeed of 60m/s, what is the landing site (Y-axis) at the highest grain number?");
        scenario2Questions.Add("How many wind speeds do all trajectories make it past an altitude of 1415m? ");
        scenario2Questions.Add("At a windspeed of 40m/s, what is the landing site (X-axis) for the highest nose length ");
        scenario2Questions.Add("How many wind speeds do all trajectories make it past a landing site (Y-axis) of -1662 metres? ");
    ...
    {
        string[] question1answers = { "Moves along the negative direction then the positive direction ", "Moves along the positive direction then the negative direction ", "Moves along the positive direction", "Moves along the negative direction" };
        ...
        string[] question4answers = { "Moves along the negative direction then the positive direction ", "Moves along the positive direction then the negative direction ", "Moves along the positive direction", "Moves along the negative direction" };
